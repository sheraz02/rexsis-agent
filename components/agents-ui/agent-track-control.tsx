  ...
  return (
    ...
    >
      <AgentTrackToggle
        ...
        className="peer/track group/track cursor-pointer focus:z-10 has-[.audiovisualizer]:w-auto has-[.audiovisualizer]:px-3 has-[~_button]:rounded-r-none has-[~_button]:border-r-0 has-[~_button]:pr-2 has-[~_button]:pl-3"
      >
        {audioTrack && (
      ...
      {kind && (
        <TrackDeviceSelect
          ...
          className={cn([
            'relative',
            'before:bg-border cursor-pointer before:absolute before:inset-y-0 before:left-0 before:my-2.5 before:w-px has-[~_button]:before:content-[""]',
